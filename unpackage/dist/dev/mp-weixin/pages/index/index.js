...
/* 12 */
/*!*****************************************************************************************************!*\
  !*** /Users/birdyyoung/Documents/HBuilderProjects/Reading/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*****************************************************************************************************/
...
/* 13 */
/*!**********************************************************************************!*\
  !*** /Users/birdyyoung/Documents/HBuilderProjects/Reading/pages/index/index.vue ***!
  \**********************************************************************************/
/*! no static exports found */
...
/* 14 */
/*!*****************************************************************************************************************!*\
  !*** /Users/birdyyoung/Documents/HBuilderProjects/Reading/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************************************************/
...
try {
  components = {
    ...
    uniSegmentedControl: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control */ "uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control.vue */ 64))
    },
    uniSection: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-section/components/uni-section/uni-section */ "uni_modules/uni-section/components/uni-section/uni-section").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-section/components/uni-section/uni-section.vue */ 71))
    },
    uniCard: function() {
...
/* 16 */
/*!***********************************************************************************************************!*\
  !*** /Users/birdyyoung/Documents/HBuilderProjects/Reading/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/birdyyoung/Documents/HBuilderProjects/Reading/pages/index/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//
//
var _default = { data: function data() {return { items: ['悬疑', '灵异', '玄幻', '全部'], activeColor: '#dd524d', current: 0, bookArray: [], novelList: [{ id: 1, avatar: 'avatar', novelname: 'novelname', author: 'author', publish_date: 'publish_date', description: 'description', url: 'url', tags: 'tags' }], pageNo: 1, limit: 5, keyWord: 'all', count: 0, userInfo: {} };}, onLoad: function onLoad() {uni.startPullDownRefresh();this.getUserInfo();}, onPullDownRefresh: function onPullDownRefresh() {var myApp = this;myApp.queryNovelBytype(myApp.items[0]);if (myApp.userInfo.openid || myApp.userInfo.username || myApp.userInfo.uuid) {myApp.loadNovelMy(1);}}, methods: { getUserInfo: function getUserInfo() {var myApp = this;uni.showModal({ title: '用户信息授权', content: '授权微信登录后才能正常使用小程序功能', success: function success(res) {if (res.confirm) {uni.getUserProfile({ lang: 'zh_CN', desc: '用户登录', success: function success(res) {var userTemp = res.userInfo;myApp.userInfo.username = userTemp.nickName;myApp.userInfo.avatarUrl = userTemp.avatarUrl;myApp.userInfo.province = userTemp.province;myApp.userInfo.gender = userTemp.gender;uni.setStorage({ key: 'userInfo', data: myApp.userInfo, success: function success() {console.info(res.userInfo);} });myApp.loadNovelMy(1); // myApp.weixinLogin();
              }, fail: function fail(err) {} });} else if (res.cancel) {}} });
    ...
    viewDetail: function viewDetail(id, name) {
    ...
    queryNovelBytype: function queryNovelBytype(type) {
      var myApp = this;
      (0, _request.default)('novel/home', {
        'limit': 30,
        'currNo': 1,
        'keyWord': type },
      {
    ...
    loadNovelMy: function loadNovelMy() {
      var myApp = this;
      (0, _request.default)('novel/query/collection', {
    ...
    jumpPage: function jumpPage(id, novelname) {
      uni.navigateTo({
    ...
    jumpSearchPage: function jumpSearchPage(value) {
      uni.navigateTo({
...
/* 19 */
/*!*******************************************************************************************************************!*\
  !*** /Users/birdyyoung/Documents/HBuilderProjects/Reading/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
